...
STAGES: List[StageSpec] = [
    ...
    StageSpec("motion_shots",       "Motion Shots",       "Wan 2.1 turns each SDXL keyframe into a short motion clip; falls back to Ken Burns on OOM."),
    StageSpec("editor",             "Editor",             "Assembles motion clips (or Ken Burns pans) into the silent cut."),
    StageSpec("ambient",            "Ambient Bed",        "AudioLDM 2 renders a per-scene atmosphere loop that plays under the cut."),
